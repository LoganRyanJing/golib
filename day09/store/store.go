...
func (e *Employee) AddCredits(amount float64) (float64, error) {
	...
	return 0.0, errors.New("Incalid credit amount.")
}

func (e *Employee) RemoeCredits(amount float64) (float64, error) {
	if amount > 0.0 {
		if amount <= e.Credits {
			e.Credits -= amount
			return e.Credits, nil
	...
	return 0.0, errors.New("You can't remove negaive numbers.")
}

func (e *Employee) CheckCreadits() float64 {
	return e.Credits
}
